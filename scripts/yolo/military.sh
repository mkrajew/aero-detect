#!/bin/bash
#SBATCH --job-name=military-yolo-zero
...
#SBATCH --mem=64G
#SBATCH -t 24:00:00
#SBATCH --output=logs/military-%j.out
#SBATCH --error=logs/military-%j.err
...
uv run ./aerodetect/modeling/train.py +db=military aug=zero
